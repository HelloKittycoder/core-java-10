...
/**
 * 自定义编译器：实现将源代码编译并加载的功能
 * Created by shucheng on 2020/9/30 15:10
 */
public class DynamicCompiler {
    ...
    public Class compileAndLoad(String fullName, String sourceCode) throws ClassNotFoundException {
        ...
        boolean result = javaCompiler.getTask(null, fileManager, null, null, null, javaFileObjectList)
                .call();
        if (result) {
